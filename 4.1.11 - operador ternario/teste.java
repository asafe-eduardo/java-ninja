class teste {
	...
	public static String situacaoVerdadeira(){
		return "Situacao verdadeira!";
	}
	
	public static String situacaoFalsa(){
		return "Situacao falsa!";
	}
	...
	public static void main(String... args){	
		...
		boolean situacaoA = true;
		boolean situacaoB = false;
	
		String resultado = situacaoA == situacaoB ? "Situacao verdadeira!" : "Situacao falsa!";
